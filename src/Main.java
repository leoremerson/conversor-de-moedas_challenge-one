...
public class Main {
    public static void main(String[] args) {
        ...
        while (continuar) {
            ...
            double taxa = ObterTaxa.consultar(de, para);
            ...
            if (taxa > 0) {
                ...
                String registro = String.format("Convertido %.2f %s para %.2f %s (taxa %.4f)", valor, de, convertido, para, taxa);
                HistoricoConversoes.registrar(registro);
            } else {
